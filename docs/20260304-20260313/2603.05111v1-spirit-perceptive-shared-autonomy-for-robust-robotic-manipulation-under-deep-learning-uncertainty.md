...
tags: ["query:hr-rob"]
score: 7.0
evidence: 不确定性下的机器人操作感知共享自主
tldr: 针对深度学习感知在安全关键任务中鲁棒性不足的问题，本文提出了一种感知共享自主系统 SPIRIT。该系统利用基于神经切线核（NTK）的感知不确定性估计来动态调节自主程度：感知置信度高时采用半自主操作，不确定性增加时则切换至触觉遥操作。通过无人机操纵实验验证，该方法在感知失效时仍能保证任务可靠性，显著提升了系统的操作性能与安全性。
selection_source: fresh_fetch
motivation: 深度学习感知在机器人应用中缺乏鲁棒性和可解释性，难以直接应用于对安全性要求极高的复杂操作任务。
method: 提出一种基于神经切线核（NTK）的不确定性感知点云配准方法，并根据不确定性水平在半自主控制与触觉遥操作之间动态切换。
result: 在 15 人的用户研究和工业模拟场景中，SPIRIT 系统在感知算法出现故障时仍能维持可靠的机器人操纵。
