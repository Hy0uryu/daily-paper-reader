...
motivation: 现有的视觉-语言-动作模型多基于静态图像预训练，缺乏对物理动力学和时空结构的深度理解。
method: 提出一种级联框架，利用双流匹配目标联合训练视频和动作扩散Transformer，通过视频生成的中间特征引导动作推理。
result: 在多个仿真和真实机器人任务中取得领先成绩，样本效率提升10倍以上，收敛速度加快达7倍。
