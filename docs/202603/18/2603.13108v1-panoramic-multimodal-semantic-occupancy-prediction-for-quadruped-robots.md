...
tldr: "针对四足机器人在复杂环境下的感知挑战，本文提出了首个真实世界全景多模态语义占据预测数据集PanoMMOcc。同时，设计了VoxelHound框架，通过垂直抖动补偿模块（VJC）解决机器人运动中的剧烈视点扰动，并利用多模态信息提示融合模块（MIPF）整合全景视觉与辅助模态信息。实验表明，该方法在mIoU上提升了4.16%，显著增强了四足机器人在具身智能场景下的三维感知能力。"
selection_source: fresh_fetch
motivation: 现有的占据预测方法多针对轮式自动驾驶设计，难以应对四足机器人运动时的剧烈抖动及复杂环境下的鲁棒性需求。
method: 提出了VoxelHound框架，包含用于抵消机身姿态干扰的垂直抖动补偿模块和融合全景视觉与多模态信息的提示融合模块。
result: "在同步发布的PanoMMOcc数据集上取得了SOTA性能，mIoU指标相比基准方法提升了4.16%。"
conclusion: 该研究通过提供首个全景多模态数据集和针对性感知框架，为具身智能系统的全景三维感知提供了系统性的评估基准和技术支撑。
---
