...
## 摘要
随着机器人系统越来越多地在非结构化、杂乱且未知的环境中运行，对结合了顺应性、适应性和精确控制的机械臂的需求日益增长。本研究提出了一种实时刚柔耦合连续体混合机械臂系统，旨在这些挑战性环境中实现鲁棒的开放世界物体到达。该系统集成了基于视觉的感知和三维场景重建，并结合形状感知运动规划来生成安全轨迹。一种基于学习的控制器驱动混合机械臂到达任意目标位姿，在利用软体段灵活性的同时保持了刚性段的精度。该系统无需针对特定环境进行重新训练，能够直接泛化到新场景。大量的真实世界实验表明，在各种杂乱设置下，该系统具有一致的到达性能，误差低于 2 厘米，突显了混合机械臂在非结构化环境中进行自适应和可靠运行的潜力。
