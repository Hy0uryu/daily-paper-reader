...
title_zh: MEVIUS2：结合钣金焊接与多模态感知的实用开源四足机器人
...
tags: ["query:hr-rob"]
score: 7.0
evidence: 具有多模态感知能力的四足机器人，可应对复杂地形
...
result: 成功研制出尺寸接近Spot的开源机器人，并验证了其在多种崎岖地形下的运动稳定性与环境感知能力。
conclusion: MEVIUS2提供了一个高耐用性、强感知能力的开源硬件平台，为大型四足机器人的研究与应用提供了实用参考。
---

## 摘要
迄今为止，多种四足机器人已被开发出来，得益于强化学习，它们现在能够穿越各种类型的复杂地形。与此同时，将这些机器人设计开源化的趋势日益增长，使研究人员能够自由地自行构建和修改机器人。然而，大多数现有的开源四足机器人是针对 3D 打印设计的，导致系统结构脆弱且尺寸扩展性差，从而只能构建相对较小的机器人。尽管存在少数使用金属部件构建的开源四足机器人，但它们往往尺寸仍然较小，且缺乏用于感知的多模态传感器，实用性较低。在本研究中，我们开发了 MEVIUS2，这是一款尺寸与波士顿动力公司（Boston Dynamics）的 Spot 相当的开源四足机器人，其结构组件均可通过电商平台订购。通过利用钣金焊接和金属加工，我们在减少零件数量的同时，实现了大型且高度耐用的机身结构。此外，通过集成激光雷达（LiDAR）和高动态范围相机等传感器，该机器人能够对周围环境进行精细感知，使其比以往的开源四足机器人更具实用性。我们通过实验验证了 MEVIUS2 可以穿越各种类型的复杂地形，并展示了其环境感知能力。所有硬件、软件和训练环境均可从补充材料或 https://github.com/haraduka/mevius2 获取。
