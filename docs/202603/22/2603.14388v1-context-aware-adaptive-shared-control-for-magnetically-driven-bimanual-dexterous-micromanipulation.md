...
tldr: 针对磁驱动微型机器人在复杂血管环境中双臂操作的高认知负担问题，本文提出Bi-CAST框架。该框架通过多模态网络融合视觉特征与空间风险指标，实时动态调整双臂控制权重，并结合双向触觉反馈实现人机协同。实验表明，该方法在血管模型导航任务中显著降低了碰撞率和操作负荷，提升了轨迹平滑度与作业效率。
selection_source: fresh_fetch
motivation: 磁驱动双臂微操纵在复杂通道中虽具灵活性，但其复杂的非线性动力学和双臂协调要求给操作者带来了极高的认知挑战。
method: 提出Bi-CAST框架，利用多模态网络实时调节控制权限，并结合双向触觉接口进行意图识别与风险感知引导。
result: "实验显示该框架使碰撞减少了76.6%，工作负荷降低了44.4%，并显著提升了轨迹平滑度与任务完成速度。"
conclusion: 上下文感知的自适应共享控制是提升磁驱动微型机器人复杂环境下双臂协作性能与安全性的有效方案。
---
